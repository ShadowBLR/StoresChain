...
//
//import by.kishko.storeschain.Entities.Store;
...
//
//    static{
//        stores.add(new Stores("Euroopt","Minsk,Bobrujsksya 99",12,0L,0L));
//        stores.add(new Stores("Mila","Minsk,Bobrujsksya 13",4,0L,0L));
//    }
//
...
//            Store store = new Stores(name,address,size,0L,0L);
//            stores.add(store);
//            model.addAttribute("stores",stores);
//        }else{
//            model.addAttribute("errorMessage",errorMessage);
...
//        int size = storesForm.getSize();
//        if(IsNotNullOrEmpty(name)&&IsNotNullOrEmpty(address)){
//            Stores store = new Stores(name,address,size,0L,0L)  ;
